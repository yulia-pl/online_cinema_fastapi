...
class JWTAuthManager(JWTAuthManagerInterface):
    ...
    _ACCESS_KEY_TIMEDELTA_DAYS = 5
    _REFRESH_KEY_TIMEDELTA_DAYS = 14
    ...
    def create_access_token(
        ...
        return self._create_token(
            ...
            expires_delta or timedelta(days=self._ACCESS_KEY_TIMEDELTA_DAYS),
        )
    ...
    def create_refresh_token(
        ...
        return self._create_token(
            ...
            expires_delta or timedelta(days=self._REFRESH_KEY_TIMEDELTA_DAYS),
        )
